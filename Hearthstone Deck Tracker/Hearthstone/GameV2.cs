...
namespace Hearthstone_Deck_Tracker.Hearthstone
{
	public class GameV2 : IGame
	{
        ...
        public static ObservableCollection<Card> getOpponentCards()
        {
            ObservableCollection<Card> OpponentCards = new ObservableCollection<Card>();

            List<Card> cardentities = API.Core.Game.Opponent.DisplayRevealedCards;
        ...
        {
            Card card = getOpponentCards().FirstOrDefault(c => c.Id == cardid);
            ...
            if (card.Rarity == Rarity.Legendary || card.Id == "GAME_005") /// on legendary or coin
            {
                return card.Count == 1;
            }
            else
