...
namespace Hearthstone_Deck_Tracker
{
    public class GameEventHandler : IGameHandler
    {
        ...
        public void SetOpponentHero(string hero)
        {
            ...
            DeckStatsList.doPrediction(API.Core.Game.Opponent.Class, 1);
            Logger.WriteLine("After do prediction on set opponent hero");
        }
        ...
        public void TurnStart(ActivePlayer player, int turnNumber)
        {
            ...
            else if (player == ActivePlayer.Player)
            {
                ...
                {
                    DeckStatsList.doPredictionLastCard(API.Core.Game.Opponent.Class, 1, GameV2.lastOpponentPlays);
                }
                else
                {
